...
public class ex2lab2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("src/ex2lab2/cantec_in.txt"));
        BufferedWriter bw = new BufferedWriter(new FileWriter("src/ex2lab2/cantec_out.txt"));
